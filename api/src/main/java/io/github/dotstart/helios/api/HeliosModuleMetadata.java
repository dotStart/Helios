...
/**
 * <p>Represents the metadata which is associated with a loaded Helios module.</p>
 *
 * <p>While this interface does not define any actual functionality, it expresses the set of
 * theoretically provided functionality in a human readable or otherwise display friendly way.</p>
 *
 * <p>Note that none of the information within this definition is required for a module to load
 * correctly. All information is purely used for logging and informing users about the origin of
 * their respective modules, where to report bugs, etc.</p>
 *
 * @author <a href="mailto:johannesd@torchmind.com">Johannes Donath</a>
 */
public interface HeliosModuleMetadata {
